...
const videoTypes = [
  ...
  {name: '6942.0p', bitrate: 53, width: 6936, height: 3912},
  {name: 'Caught in better 4k', bitrate: 53, width: 3840, height: 2160},
  {name: 'Caught in 4k', bitrate: 24, width: 2560, height: 1440},
  ...
  {name: 'idk', bitrate: 1, width: 7680, height: 4320}
];
...
function saveProject() {
  ...
  zip.generateAsync({type: 'blob'}).then(blob => {
    ...
    saveLink.href = url;
    saveLink.download = 'untitledmeme69.bacc';
